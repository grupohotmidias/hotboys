								...
								<div id="content-wrapper" class="d-flex flex-column">
									...
									<div id="content">
										...
										<div class="container-fluid">
											...
											<?php if($id_ator == ''){?>
												<div class="alert alert-danger" role="alert"><?= $_SESSION["id_ator"] ?>
													Você não está logado. Faça login <a href="../">aqui</a> e tenha acesso à sua conta!
												</div>
											<?php } ?>
																		...
																		<tbody>
																			...
																			<tr>
																				...
																				<?php if($statusAtor =='Ativo'){ ?>
																					<td><?= $statusAtor ?></td>
																					<?php }else if($statusAtor =='Inativo'){ ?>
																					<td class="vazio"><?= $statusAtor ?></td>
																					<?php }else{ ?>
																					<td class="vazio">Vazio</td>
																				<?php } ?>
																			</tr>
																			<?= $msg ?>
													...
													<div class="col-12">
														<div class="card shadow">
															...
															<div class="col-12 foto-galeria card-body">
																...
																<form action="<?php echo $SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data" id="minha_conta">
