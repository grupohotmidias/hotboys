...
function daily_insight_entry_footer() {
	...
	if( !empty( $tags_list ) ){
		echo '<div class="tag-list">
		  		<span class="screen-reader-text">'. esc_html__( 'Tagged', 'daily-insight') .' </span>';
...
function daily_insight_get_entry_meta(){ 
	...
	$posted_on = sprintf(
		_x( '<span class="posted-on-text">Postado em:</span> %s', 'post date', 'daily-insight' ),
	    ...
	    <div class="pull-left">
	        <span class="byline">
	            <span class="author vcard"><?php echo $author_profile_avatar; ?>
	            	<span class="screen-reader-text"><?php esc_html_e( 'Author', 'daily-insight' ); ?></span> 
	                <a class="url fn n" href="<?php echo esc_url( $author_profile_link ); ?> "><?php echo esc_html( $author_name ); ?></a>
	            </span>
	        </span><!-- .byline -->

	        <span class="posted-on">
	            <span class="screen-reader-text"><?php esc_html_e( 'Posted on', 'daily-insight' ); ?></span>
