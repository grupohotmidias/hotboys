<?php require('config/configuracoes.php');
	...
	if(isset($recaptcha_response)){
		...
		if($answer->success) {
			...
			$msg->Subject  = 'Conto enviado por internauta';
			...
			$conto = addslashes(utf8_decode($_POST[mensagem]));
			...
			<body>
			<b>Conto enviado por internauta no site HotBoys</b><br><br>
			<b>Nome:</b> '.$nome.' '.$sobrenome.' <br />
			<b>Email:</b> '.$email.'<br><br>
			<b>Suporte para o Site:</b> HOTBOYS <br /><br />
			<b>Assunto do Conto:</b> '.$assunto.'<br><br>
			
			<b>Conto:</b><br>'.$conto.'<br />
			...
			if ($enviado){
				...
				<strong>O seu conto foi enviado com sucesso !</strong> 
				</div>
				</div>
				'
			?>
...
<html lang="pt-br" class="no-js">
	...
	<body id="body" class="fundo-preto"> 
		...
		<div class="container-tudo">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<h1 class="contato_email-titulo">Conte-nos a sua experiêcia HOT</h1>
			</div>
					...
					<div class="text-justify col-md-9 texto-pagina-contato_trabalhe">
						...
						<div class="container container-table">
							<div class="col-md-12 col-xs-12 contato_email-titulo-conteudo">
								<p>Você tem alguma história picante para nos contar? Então se entregue sem medo e coloque seu conto erótico aqui no site mais quente da net. E deixe que sua história de tesão nos proporcione prazer também.</p>
							</div>
						</div>
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-md-6 col-sm-12 col-xs-12 input-box form-group">
											<input class="form-control sel1" name="nome" id="sel1" value="" required style="border: 1px solid rgba(255, 255, 255, 0.59)!important; background-color: #e8e5e5!important;"/>
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-md-6 col-sm-12 col-xs-12 formulario-col-direita input-box form-group">
											<input class="form-control sel1" name="sobrenome" id="sel1" value="" required style="border: 1px solid rgba(255, 255, 255, 0.59)!important; background-color: #e8e5e5!important;"/> 
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 input-box form-group">
										<input class="form-control sel1" type="E-mail" name="email" id="sel1" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required style="border: 1px solid rgba(255, 255, 255, 0.59)!important; background-color: #e8e5e5!important;"/>
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 input-box form-group">
										<input
										class="form-control sel1" name="assunto" id="sel1" required style="border: 1px solid rgba(255, 255, 255, 0.59)!important; background-color: #e8e5e5!important;"/>
										<span class="unit">Assunto do conto:</span>
									</div>
									
									<!-- Conte-nos sua experiência aqui! -->
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 input-box  form-group">
										<textarea class="form-control sel1" id="sel1" name="conto" rows="12" required style="border: 1px solid rgba(255, 255, 255, 0.59)!important; background-color: #e8e5e5!important;"/></textarea>
										<span class="unit">Conte-nos sua experiência aqui!</span>
									</div>
								</div>
	...
	<!-- FIM Container Mae - Engloba todo o conteudo -->
