...
<body>
	...
	<?php
		$consulta_imagens=mysql_query("SELECT * FROM `imagens_amadoras` WHERE `id_referencia`='$_GET[id]' ORDER BY `id` DESC");
	...
	?>
					...
					<a href="https://hotboys.com.br/vip/amador/cena/<?=$dados_cena['id']?>/<?=$dados_cena['titulo']?>">
