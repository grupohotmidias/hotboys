        ...
        $section_icon =  !empty( $options['category_block_three_icon'] ) ?  $options['category_block_three_icon'] : '';
            ...
            <header class="entry-header">
                <h2 class="entry-title category-title">
					<img class="icone-pimenta-blocos" src="https://hotboys.com.br/blog/wp-content/uploads/2018/11/icone-pimenta-rodape.gif"/>
                            ...
                            <div class="column-wrapper">
                                ...
                                <div class="post-wrapper">
                                    ...
                                    if( !empty( $readmore_text ) ) : ?>
                                       <a href="<?php echo esc_url( $content['url'] ); ?>" class="view-more"><?php echo esc_html('Saiba Mais','daily-insight'); ?></a>
                                    <?php endif; ?>
                                </div><!-- .post-wrapper -->
                            </div><!-- .column-wrapper -->
