<?php
	...
	if ($detect->isMobile()) { 
		...
		if( $_SESSION['en'] == 'true') {
			header("Location: http://www.hotboys.com.br/en/");
		}
			...
			<div class="row" style="float:left;width:100%;margin-top:20px;">
				<div class="col-sm-12 col-xs-12 col-md-12 col-lg-12 ">
					<?php 
						...
						$query_banners = "SELECT * FROM `banners_2018` WHERE status='Ativo' AND posicao='quarentena'  LIMIT 1 ";
							...
							<?php if ($detect->isMobile()) { ?>
								...
								<div class=" col-sm-3 col-xs-4 inicial_box_conteudo" style="border:0px !important;">
									...
									<div>
										...
										<?php }else{?>
										<a data-fancybox="gallery" href="//server2.hotboys.com.br/arquivos/<?php echo $dados_rede['img']?>">
											<video style="width:98%;" width="119" controls autoplay="true">
								...
								<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 inicial_box_conteudo">
									...
									<div>
										...
										<a data-fancybox="gallery" href="//server2.hotboys.com.br/arquivos/<?php echo $dados_rede['media']?>">
											<video style="width:100%;" width="272" controls>
												<source src="//server2.hotboys.com.br/arquivos/<?php echo $dados_rede['media']?>" type="video/mp4">
