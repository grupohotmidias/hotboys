...
<html lang="pt-BR">
	...
	<body class="painel" onload="window.location='#video'">
												...
												<div class="col-xl-8 col-lg-7">
													<div class="card shadow mb-4">
														...
														<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
															...
															<!-- editar -->
															<div class="dropdown no-arrow">
																<a class="dropdown-item" href="<?= URL ?>admin/login/editar-info/"><i class="fas fa-pencil-alt fa-1x"></i></a>
															</div>
														</div>
															...
															<form action="" method="post">
																<div class="card-body">
																	...
																	<div class="chart-area my-3" style=" margin:0 auto;text-align:center">
																		<div class="col-12 col-sm-9 mb-3" style="margin:0 auto">Insira a URL do vídeo</div>
		...
		<!-- Javascript que rola a pagina para a edicao do video assim que carregada -->
		<script
