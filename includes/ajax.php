       ...
       if($_GET['acao']=='newsletter'){
            ...
            //preencheu apenas o email
                ...
                $htmlSaida = '<div class="rodape-newsletter-campo">
                    <input type="text" name="newsletter_rodape_nome" id="newsletter_rodape_nome" placeholder="Nome Completo" required="required" class="form-control" pattern="[A-Za-z\s]+$"/>
                </div>

                <div class="rodape-newsletter-campo">
                    <input type="text" name="newsletter_rodape_nascimento" id="newsletter_rodape_nascimento" placeholder="Data de Nascimento" required="required" class="form-control data" />
                </div>
                
                <input type="hidden" name="newsletter_rodape_email" id="newsletter_rodape_email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" value="'.$email.'">';
                $mensagem = 1;
            }
