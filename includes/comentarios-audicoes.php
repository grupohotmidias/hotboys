<?php
	...
	if($_POST['acao'] == 'cadastrar' ){
		...
		$query_v = "SELECT * FROM `audicoes_comentarios` WHERE mensagem='$mensagem' AND nome='$nome'  AND estado='$estado' ";
		...
		if($total_v >= 1){
			...
			$query = "INSERT INTO `audicoes_comentarios` (
			`id` ,
			`video` ,
			`tipo` ,
			`data` ,
	...
	if($_POST['acao'] == 'responder'  ){
		...
		// consulta se menssagem ja existe.
		$query_v = "SELECT * FROM `audicoes_comentarios` WHERE mensagem='$mensagem' AND nome='$nome' AND email_cliente='$email_cliente'  ";
		$consulta_v = mysql_query($query_v);
		$total_v = mysql_num_rows($consulta_v);
	...
	$query = "SELECT * FROM `audicoes_comentarios` WHERE video='$id'  AND resposta='0' AND tipo='$pg' AND status='1' order by id desc LIMIT 3";
						...
						<div class="container container-table" id="scrollinfinito">
							<div class="text-justify col-lg-12 col-md-12 col-sm-12 col-xs-12 espaco-comentarios">
								...
								<?php
									...
									$query_resposta = "SELECT * FROM `audicoes_comentarios` WHERE video='$id'  AND id_resposta='$id_comentario' AND resposta='1' AND tipo='$pg' And status='1'  order by id asc";
