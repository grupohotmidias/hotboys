		...
		<div class="votacao-audicoes">
			...
			<div class="col-lg-9 col-md-12 texto-pagina-contato_trabalhe">
				<div class="col-lg-12 col-xs-12">
					<h1 class="chamada-enquete"><?php echo utf8_encode('ELIMINE 2 PRÉ-CANDIDATOS (1 ATIVO E 1 PASSIVO) PARA SAÍREM DAS AUDIÇÕES HOT 3') ?></h1>
				</div>
					...
					<form>
						<?php	
							...
							<div class="col-lg-12 col-xs-12">
								...
								<img src="https://www.hotboys.com.br/imagens/pimenta-votacao.png"> <?php echo utf8_encode($linha[pergunta]) ?></h1>
							</div>
