<?php
	...
	$query_modelos_preferidos = "SELECT * FROM `modelos` WHERE `exibicao`='Todos' AND status='Ativo' AND modelo_perfil <>'' AND preferidos='Sim' ORDER BY ordem LIMIT $inicio_consulta, 20";	
	...
	$query_modelos_exclusivos = "SELECT * FROM `modelos` WHERE `exibicao`='Todos' AND status='Ativo' AND modelo_perfil <>'' AND exclusivos='Sim' ORDER BY ordem LIMIT $inicio_consulta, 20";	
