	...
	<div class="container-fluid desktop d-none d-md-block">
		...
		<?php while($exibe_lista = mysql_fetch_array($dados_lista)){  ?>
			...
			<div class="row noticiasLista">
				...
				<!-- conteudo da lista -->
				<div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-9 conteudoLista">
					...
					<a href="<?php echo URL_VIP ?>cenas-audicoes-novo" role="button" class="btn btn-primary btn-sm mt-3">LEIA MAIS<i class="fa fa-chevron-right" style="margin-left: 10px"></i></a>
				</div>
			</div>
		<?php } ?>
	</div>
