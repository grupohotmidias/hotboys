...
if ( ! function_exists( 'daily_insight_render_latest_post_section' ) ) :
    ...
    function daily_insight_render_latest_post_section( $content_details = array() ) {
        ...
        <?php if ( is_active_sidebar( 'category_block_one_footer_sidebar' ) ) { ?>
        <section id="google-advertisement" class="container page-section">
            <?php dynamic_sidebar( 'category_block_one_footer_sidebar' ); ?>
        </section><!-- end .google-advertisement -->
        <?php }
    }
endif;