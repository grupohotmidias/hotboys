<?php
	...
	if($tag != ''){
		...
		$Paginacao->SiteLink = URL_VIP.'videos';
		...
		$query_cenas = "SELECT * FROM `cenas` WHERE status='Ativo' $complemento LIMIT $inicio_consulta, 24";
										...
										<nav aria-label="Page navigation example" class="navigation">
											<ul class="pagination justify-content-center">
												<?php //Se a paginação estiver em um numero maiso que 1 aparece o voltar
													if($pgAtual > 1){ ?>																		
													<li class="page-item"><a class="page-link" href="<?php echo URL_VIP.'videos/'.(-$Paginacao +$pgAtual) ?>">Anterior</a></li>
												<?php } ?>	
												...
												<?php //Botao avançar
													...
													<li class="page-item"><a class="page-link" href="<?php echo URL_VIP.'videos/'.($Paginacao +$pgAtual) ?>">Próxima</a></li>	
												<?php } ?>			
											</ul>
										</nav>
