...
<?php if($vip != true){ ?>
		...
		<div class="rodape-banner-fixo" data-promo="default" style="padding-bottom:0!important">
		<img src="https://hotboys.com.br/imagens/rodape/rodape-fixo/rodape_assine_mobile2020.png?v=25" alt="rodape fixo Hotboys">
		</div>
		</a>
		<?php }else{ ?>
		...
		<img src="https://hotboys.com.br/imagens/rodape/rodape-fixo/rodape_assine2020.png?v=25" alt="rodape fixo Hotboys">
		</div>
		</a>
		<?php } ?>
	</div>
	...
	<!-- rodape contador 
		...
		<div class="rodape-banner-fixo" style="background-color:black">
		<div class="col-12 col-sm-7 p-0" data-promo="default" style="margin: 0 auto">
		<div class="rodape-fixo-black-friday">
		<div class="col-sm-5 col-xs-5 col-md-5 col-lg-5 logo-black-friday">
		<img src="<?php echo URL ?>imagens/black-friday/02/black-friday-rodape-relogio.jpg?v=20" style=""/>
		</div>
		<div class="col-sm-7 col-xs-7 col-md-7 col-lg-7 relogio-blackfriday" style="padding: 10px 0;">
		<div class="flipper" data-reverse="true" data-datetime="2019-12-01 00:00:00" data-template="dd|HH|ii|ss" data-labels="Dias|Hs|Min|Seg" id="myFlipper"></div>
		</div>
		</div>
		</div>
		</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 rede-social" align="center">
								...
								<form class="form-inline" action="" onsubmit="cadastrarNewsletter(); return false;">
									<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
										<div class="input-group form-group" id="newsletter-rodape">
											<input type="email" name="newsletter_rodape_email" id="newsletter_rodape_email" placeholder="Informe seu e-mail" required class="form-control" style="z-index:0!important;height:32px!important" />
										</div>
									</div>
									
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 btn-warning"  id="btn-rodape-newsletter">
										<input type="submit" value="Assinar" class="btn btn-warning" style="width:100%;height:32px;padding: 0px!important" />
									</div>
								</form>
							</div>
						</section>
				...
				<div class="col-lg-8 col-md-12 col-sm-12 col-xs-12 col-lg-offset-2 col-lg-offset-right-2" id="redes-sociais">
					<div class="footer-rede-social-tudo">
						...
						<span class="col-lg-3 col-md-3 col-sm-3 col-xs-3" align="center">
							<a href="https://twitter.com/HotboysSite" target="_blank" class="fa">
								<i class="fab fa-twitter"></i>
							</a>
						</span>
						
						<span class="col-lg-3 col-md-3 col-sm-3 col-xs-3" align="center">
							<a class="fa" href="https://www.instagram.com/hotboys.produtora/">
