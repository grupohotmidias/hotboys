<?php
	...
	<div class="container">
	<div class="row">
	<img src="<?php echo URL ?>novo-projeto/assets/img/audicoes/bustos-home05.png?v=<?php echo Version; ?>">
	</div>
	</div>
	</section>
	...
	<div class="row">
	<img src="https://www.hotboys.com.br/imagens/audicoes/fases/fase-05-ativa.png" class="mx-auto">
	</div>
	</div>
	...
	<a href="<?php echo URL_VIP ?>audicoes/videos/" role="button" class="btn btn-primary btn-sm mx-auto mb-3">VER MAIS CENAS<i class="fa fa-chevron-right" style="margin-left: 10px"></i></a>
	</div>
