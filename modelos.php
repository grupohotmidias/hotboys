...
@keyframes muda{
  ...
  <div class="pages-all" style="background: #0d0d0d;">
    ...
    <label class="btn btn-danger" style="background-color:#ffffff;color:#000000;border: 1px transparent;padding: 6px;border-radius: 0px 5px 5px 0px;" for="page-7">&nbsp;&nbsp;7&nbsp;&nbsp;</label>
    <?php /* <label class="btn btn-danger" style="background-color:#ffffff;color:#000000;border: 1px transparent;padding: 6px;border-radius: 0px 5px 5px 0px;" for="page-8">&nbsp;&nbsp;8&nbsp;&nbsp;</label> */ ?>
  </div>
  <?php }else{ ?>
								...
								<div class="conteudoModelo">
									...
									<div class="paginas-titulo-visualizacoes">	
										<h4 class="paginas-nome-modelos" style="text-align:center;">
											...
											<i style="font-size: 9px;">Exclusivo</i>
										</h4>	
