			...
			<div class="container container-table">
				<div class="col-md-9">
					<div class="text-justify col-md-12 contato_modelo-texto">
						<p class="paragrafos">Caso em sua tela apareça qualquer erro referente ao <span class="tutorial_texto_destaque">Excesso de Redirecionamento</span> ou <span class="tutorial_texto_destaque">Limpeza de Cookies</span>, siga as instuçoes abaixo:</p>
					</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 perguntas-frequentes" style="margin-top: 10px">
						...
						<span class="tutorial_cookies"><img src="http://www.hotboys.com.br/_m/images/tutoriais/tuto_limp_cache_0.png"></span>
					</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 perguntas-frequentes" style="margin-top: 50px">
						...
						<span class="tutorial_cookies"><img src="http://www.hotboys.com.br/_m/images/tutoriais/tuto_limp_cache_1.png"></span>
					</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 perguntas-frequentes" style="margin-top: 50px">
						...
						<span class="tutorial_cookies"><img src="http://www.hotboys.com.br/_m/images/tutoriais/tuto_limp_cache_2.png"></span>
					</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 perguntas-frequentes" style="margin-top: 50px">
						...
						<span class="tutorial_cookies"><img src="http://www.hotboys.com.br/_m/images/tutoriais/tuto_limp_cache_3.png"></span>
					</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 perguntas-frequentes" style="margin-top: 50px">
						...
						<span class="tutorial_cookies"><img src="http://www.hotboys.com.br/_m/images/tutoriais/tuto_limp_cache_4.png"></span>
					</div>
