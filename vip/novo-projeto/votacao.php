                    ...
                    <div class="app-main__inner">
						...
						<div class="container-fluid">
							...
							<section class="logoAudicoes">
								<div class="container">
									<div class="row">
										<img class="mx-auto" id="foto<?php echo $counter3++ ?>" src="https://www.hotboys.com.br/imagens/audicoes/votacao/logo-eliminacao-audicoes.png?v=<?php echo Version; ?>"/>
									</div>
								</div>
							</section>
															...
															<label>
																<div class="card participantes mb-0 p-0 box-shadow" onclick="show<?php echo $counter++ ?>()">
																	...
																	<div class="thumb" style="position:relative">
																		...
																		<!-- Icone de voto -->
																		<img src="https://www.hotboys.com.br/imagens/audicoes/pre-candidatos/icone-voto.png" id="selecionado<?php echo $counter++ ?>" style="visibility:hidden">
																	</div>
