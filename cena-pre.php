	...
	$query_teaser = "SELECT * FROM `cenas` WHERE `exibicao`='Todos' AND status='Ativo' ORDER BY id DESC LIMIT 1";
					...
					<div class="col-lg-9 mx-auto text-justify cena-apresentacao-texto"> 
								...
								<div class="row texto-cena" style="float:left;width:100%;padding:10px">
									...
									<?php }else{?>
										...
										<a href="<?php echo URL ?>assine?id=<?php echo $id = $_GET['id'];?>">
			                                <img src="<?php echo URL ?>imagens/black-friday/cena-pre-black-friday.jpg?v=100" style="width:100%;margin-bottom:10px"/>
						...
						<div class="col-lg-6 col-md-5 col-sm-12 col-xs-12" style=" background-color: #262626; padding: 10px; margin-top:10px">
							...
							<?php if ($detect->isMobile()) { ?>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 modelos-assine" >
									
									<!-- IMAGEM DO BANCO DE DADOS MODELO_ASSINE -->
									<img src="<?php echo URL ?>imagens/black-friday/black-friday-assine.jpg" alt="image assine" style="width:100%;margin-bottom: 15px;margin-top: 20px;"/>
								...
								<a href="https://www.gpagamentos.com.br/1/acesso-via-hotboys.php">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-20">
										<!-- Imagem assine agora -->
										<img src="<?php echo URL ?>imagens/assine/assine-cena-mobile.png" style="width:100%"/>
									</div>
									
									
									
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 plano-cena mobile"> 
										<div class="periodo-plano">Plano Anual</div>
										<div class="plano"><span class="gold_assine">GOLD</span> HOT</div>
										<div class="valor">R$ 240,00</div>
									</div>
									
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 plano-cena">
										<div class="periodo-plano">
											Plano Semestral
										</div>
										<div class="plano"><span class="premium_assine">PREMIUM</span> HOT</div>
										<div class="valor">R$ 119,80</div>
									</div>
									
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 plano-cena mobile">
										<div class="periodo-plano">Plano Bimestral</div>
										<div class="plano"><span class="top_assine">TOP</span> HOT</div>
										<div class="valor">R$ 49,90</div>
									</div>
									
									
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 plano-cena">
										<div class="periodo-plano" style="background-color:#e31330;color:white;">Plano Trimestral</div>
										<div class="plano"><span style="color:#e31330">PRÉ</span> Black Friday</div>
										<div class="valor">R$ 30,00</div>
									</div>
									
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 plano-cena mensal">
										<div class="periodo-plano">
											Plano Mensal
										</div>
										<div class="plano hot_assine">HOT</div>
													...
													<div class="cartao-credito-conteudo">
														<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 opcao-pagamento" id="assine-valores1" style="display: block;">							
															...
															<div class="row">
																...
																<!-- trimestral -->
																<a href="https://gpagamentos.com.br/1">
																	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 conteudo-planos-pagamento" style="background-image: linear-gradient(#292828, #292828);">
																		
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 titulos-planos-esquerda" >
																			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><span style="color:#e31330">PRÉ</span><span style="color: #fff"> BLACK FRIDAY</span> 
																					</div>
																			
																			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																				<span class=" col-xs-12 plano-cartao-texto" style="color:#fff">Plano Trimestral</span>
																			</div>
																		</div>
																		
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 titulos-planos-direita">
																			<div class="precos-planos" style="color:#fff">
																				<div class="moeda">R$</div>
																				<div class="reais">30</div>
																				<div class="centavos">,00</div>
																			</div>
																			
																			<div class="precos-parcelas-planos" style="color: #fff;">Apenas R$ 10,00 por 
																			mês</div>
																		</div>
																	</div>
																</a>
