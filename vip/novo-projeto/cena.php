											...
											<?php  
												while($elenco = mysql_fetch_array($consulta_elenco)){
													...
													<li class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6 cenas">
														<a href="<?php echo utf8_encode(URL_VIP.'modelo/'.$modelo[id].'/'.URL_amigavel($modelo[nome])) ?>">
										...
										<div class="page-title-wrapper">
											...
											<div class="page-title-heading">
												<?php if($total_comentario == 1){ ?>
													<h5> (1) Comentário nesta cena</h5>
													<?php }else{ ?>
													<h5><?php echo $total_comentario ?> Comentários nesta cena</h5>
												<?php } ?>
