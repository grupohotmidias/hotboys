<?php
	...
	$menu_lateral = 'includes/estrutura/menu/menu-lateral2.php';
...
<html lang="pt-BR">
	...
	<body class="vip home">
		...
		<div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header closed-sidebar">
				...
				<div class="conteudoTudo">
					<div class="app-main__outer mt-2">
						<div class="app-main__inner">
							<button id="open-modal" type="button" class="" data-toggle="modal" data-target="#myModal" style="position:relative;top:-50px;"></button>
						...
						?>	
							...
							<?php if ($detect->isMobile()) { ?>
								...
								<div class="col-xl-2 col-lg-2 col-md-2 col-sm-6 col-12 cenas p-1" style="float:left;overflow: hidden">
			...
			<?php
				$consulta_novidades = mysql_query("SELECT * FROM `novidades` ORDER BY `id` DESC");
				$dados_novidades = mysql_fetch_array($consulta_novidades);
			?>
			<style>
			p {
				color: #000;
			...
			aria-hidden="true" data-backdrop="true">
				...
				style="z-index:9999999;position:relative;top:15%;">
					<!--Content-->
					<div class="modal-content">
					<!--Header-->
					<div class="modal-header">
						<span class="heading"><strong>AVISO</strong>: <?= $dados_novidades['titulo']?>
						</span>
					...
					<div class="modal-body">
						...
						<div class="row">
						<div class="col-12">
							<?=$dados_novidades['media']?>
						</div>
						<div class="col-12">
							<p style="color: #000; !important">
								<?=$dados_novidades['descricao']?>
							</p>
						</div>
						</div>
					</div>
