...
<div class="row" style="float:left;width:100%;margin-top:20px">
	<div class="col-sm-12 col-xs-12 col-md-12 col-lg-12 ">
		<?php 
			...
			$query_banners = "SELECT * FROM `banners_2018` WHERE status='Ativo' AND exibicao IN('Todos','Vip') AND posicao='cena' LIMIT 1";
...
<?php } */?>
							...
							<div id="content">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mx-auto cena-video-espaco-largura-cheia" >  
                                    <div class="col-lg-9" style="float: none!important;margin:0 auto;padding:0">
                                        <ul class="nav nav-tabs" role="tablist">
											...
											<?php if ($dados_conteudo[video2_code] !=""){ ?>
												<li class="nav-item">
													<a class="nav-link" href="#video-alt" role="tab" data-toggle="tab">Vídeo Alternativo</a>
												</li>
											<?php } ?>
											...
											<?php } ?>
											<?php if ($dados_conteudo[amador_code] !=""){ ?>
												<li class="nav-item">
													<a class="nav-link" href="#video-a" role="tab" data-toggle="tab">Vídeo Amador <span class="badge badge-warning" style="color: #fff;">NEW</span></a>
												</li>
											<?php } ?>
										</ul>
									</div>
                                ...
                                <div class="tab-content">
									...
									<?php if ($dados_conteudo[video2_code] !=""){ ?>
										<div role="tabpanel" class="tab-pane fade" id="video-alt">
											<!-- Video -->
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mx-auto cena-video-espaco-largura-cheia" >
												<div class="col-lg-9" style="float: none!important;margin:0 auto;padding:0">
													<div class="video-sprout">
														<?php echo $dados_conteudo[video2_code]; ?>
													</div>
												</div>
											</div>
										</div>
									...
									<?php } ?>
									<?php if ($dados_conteudo[amador_code] !=""){ ?>
										<div role="tabpanel" class="tab-pane fade" id="video-a">
											<!-- Video -->
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mx-auto cena-video-espaco-largura-cheia" >
												<div class="col-lg-9" style="float: none!important;margin:0 auto;padding:0">
													<div class="video-sprout">
														<?php echo $dados_conteudo[amador_code]; ?>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 inicial_box_conteudo" style="display:contents;float:left;">
									...
									<?php
										...
										<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6" style="overflow: hidden;height: 166px;">
											<a class="lightbox" href="http://server2.hotboys.com.br/arquivos/<?php echo $row_imagemcena_random['imagem']?>">
												<img style="width:100%;" src="http://server2.hotboys.com.br/arquivos/<?php echo $row_imagemcena_random['imagem']?>">
											</a>
										</div>
										...
										<ul>
											...
											<div class="row" style="float:left;width:100%">
												...
												<div class="col-lg-12 col-sm-12 bt-vejamais-desktop modelos">
													...
													<h5 class="bt-vejamais" style="float:right;text-align:right;"><a href="<?php echo URL_VIP ?>videos/">Mais Cenas <i class="fas fa-caret-right fa-1x" aria-hidden="true"></i></a></h5>
