				...
				<div class="col-sm-12 col-xs-12 col-md-12 col-lg-12 ">
					<?php 
						...
						<?php 
							$counter = 1;
							if($total_banners >= 0){ ?>
						<?php /*	<a href="<?php echo $dados_banners[link].'"'.'target="'.$dados_banners[janela].'"'; ?>">
			...
			<?php if ($detect->isMobile()){ ?>
				...
				<div class="row home-modelos desktop" style="float:left; width:100%;">
					<?php
						...
						$hoje = gmdate("Y-m-d");
						$qry = "SELECT id, id_conteudo, tipo, COUNT(*) as conta FROM visita_conteudo WHERE id_conteudo NOT IN(86,272,273) AND tipo=1  AND data>'$tempo'  GROUP BY id_conteudo ORDER BY conta desc limit 9";
					...
					<div class="col-12 col-sm-7 rodape-banner-fixo p-0" data-promo="default" style="margin: 0 auto">
						<div class="rodape-fixo-black-friday">
							<div class="col-sm-4 col-xs-4 col-md-4 col-lg-4 logo-black-friday">
								<img src="imagens/black-friday/logo-pre-black-friday.png?v=6" style=""/>
								</div>
