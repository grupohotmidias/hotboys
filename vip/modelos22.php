														...
														<a href="<?php echo URL_VIP.'ator/'.$row_modelos[id].'/'.URL_amigavel($row_modelos[nome])?>">
															...
															<div class="card-body">
																...
																<?php 
																	...
																	$query_favoritar="SELECT * FROM `usuarios_favoritos` WHERE `id`='$id' AND `id_usuario`='$id_cliente'";
																	$consuta_favoritar=mysql_query($query_favoritar);
																
																	$row_favoritar=mysql_num_rows($consulta_favoritar);
																		$array_favoritar=mysql_fetch_array($consulta_favoritar);
																		var_dump($row_favoritar);
																	...
																	<div style="width:20%;float:left;color: yellow">
																		<i class="fas fa-star fa-1x"></i>
																	</div>
																	
																	<?php }else{ ?>
																		<form action="">
																		<div style="width:20%;float:left;color: gray">
																			<i class="fas fa-star fa-1x"></i>
																		</div>
																	</form>
